...
- **Версия**: 2.1.10-1
- **Дата создания версии**: 4 марта 2026, 10:41
- **Изменено в версии**: Стили в admin-panel.html возвращены как было (потому что надоело уже их чинить) P.S. 10-1 потому что дату поставить забыл
- **Автор**: Timon4ik
