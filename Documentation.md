...
- **Версия**: 2.1.12-1
- **Дата создания версии**: 4 марта 2026, 11:28
- **Изменено в версии**: Удалён лидерборд из админ панели (потому что удалён сам файл страницы, толку от кнопки в никуда?)
- **Автор**: Timon4ik
