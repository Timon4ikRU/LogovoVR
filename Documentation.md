...
- **Supabase JS Client v2** - система аутентификации и база данных (P.S.: в данный момент у владельца сайта нет доступа к Supabase из-за того что он сайт не загружается)
...
- **Индикатор входа**: 👤 (меняет цвет при авторизации)
...
## ❄️ Снежинки (декоративный элемент)
...
### Разметка версий
- **X.__.__**: Глобальное обновление сайта (редизайн **3 и более** страниц/добавление **10 и более** новых функций/т.п.)
- **_.XX.__**: Крупное (не глобальное) обновление сайта (добавление **менее чем 10 новых функций**/редизайн **менее чем 3** страниц)
- **_.__.XXX**: Bug-fix
- **_.__.___-x**: Обновление документации
