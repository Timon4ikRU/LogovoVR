...
P.S.: временно вырезаны на время не-зимнего периода
...
- **Версия**: 3.2.1
- **Дата создания версии**: 9 мая 2026, 07:00 (на деле 21 мая, 16:08 но разраб не хочет признавать что пропустил обнову на 9 мая)
- **Изменено в версии**: news.html - добавлено поздравление с 9 мая
- **Автор**: Timon4ik
